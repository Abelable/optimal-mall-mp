...
Component({
  ...
  methods: {
    ...
    storeValue() {
      ...
      beautyValue != 0 &&
        wx.setStorage({ key: "beautyValue", data: beautyValue });
      whitenessValue != 0 &&
        wx.setStorage({ key: "whitenessValue", data: whitenessValue });
      visualFilterValue != 0 &&
        wx.setStorage({ key: "visualFilterValue", data: visualFilterValue });
      soundFilterValue != 0 &&
        wx.setStorage({ key: "soundFilterValue", data: soundFilterValue });
    },
